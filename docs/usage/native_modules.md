...
LCM is a simple [UDP multicast](https://lcm-proj.github.io/lcm/content/udp-multicast-protocol.html#lcm-udp-multicast-protocol-description) protocol with a straightforward [message definition language](https://lcm-proj.github.io/lcm/content/lcm-type-ref.html#lcm-type-specification-language), making it easy to implement in any language. Our types are ported from ROS and autogenerated from the [dimos-lcm](https://github.com/dimensionalOS/dimos-lcm/) repository.
